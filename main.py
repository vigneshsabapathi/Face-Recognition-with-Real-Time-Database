...
firebase_admin.initialize_app(
    cred,
    {
        ...
        "storageBucket": "faceattendancerealtime-3d00e.appspot.com",
    },
)
...
while True:
    ...
    if faceCurFrame:
        ...
        if counter != 0:
            ...
            if counter == 1:
                ...
                secoundsElapsed = (datetime.now() - datetimeObject).total_seconds()
                print(secoundsElapsed)
                if (
                    secoundsElapsed > 30
                ):  # convert to secounds the nessecary amount of time between needing to mark attendance
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    cv2.getTextSize(studentInfo["name"], cv2.FONT_HERSHEY_COMPLEX, 1, 1)
    ...
    if cv2.waitKey(1) & 0xFF == ord("q"):
        break
# Add Async function for faster response
